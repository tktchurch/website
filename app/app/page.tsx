    ...
    return (
        <div>
            ...
            >
                ...
                {/* left mobile image */}
                <div id='leftImage' className='w-[288px] h-[306px] lg:h-[640px] border-[1.5px] rounded-lg border-white relative top-[0%] mt-12 lg:top-[50%] left-[10%] lg:left-[15%] -rotate-12 transition-transform duration-700 ease-in-out translate-y-[35%]'>
                    <Image
                        fill
                ...
                {/* right mobile image */}
                <div id='rightImage' className='w-[288px] h-[306px] lg:h-[640px] border-[1.5px] rounded-lg border-white relative top-[7%] lg:top-[53%] -right-1/4 lg:-right-[5%] rotate-12 transition-transform duration-700 ease-in-out translate-y-[35%]'>
                    <Image
                        fill
                ...
                {/* center mobile image */}
                <div id='centerImage' className='w-[288px] h-[306px] lg:h-[640px] border-[1.5px] rounded-lg border-white relative -top-[5%] lg:top-[30%] right-[33%] lg:right-[20%] transition-transform duration-700 ease-in-out translate-y-[35%]'>
                    <Image
                        fill
