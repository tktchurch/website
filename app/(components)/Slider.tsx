...
export default function Slider() {
  return (
    <>
      ...
      >
        <section className="border-2 border-red-600 h-96">
          <SwiperSlide key={1}>
            <div className="flex flex-col lg:flex-row justify-evenly items-center px-24 py-4 lg:py-24 bg-amber-400 h-[40rem]">
              ...
              <div className="text-gray-700 px-4 py-2 lg:m-2">
                <div className="flex flex-col items-center">
                  <h3 className="font-semibold text-[32px] lg:text-7xl text-[#0F0F0F] mb-5 text-start">
                    Explore Us
                  </h3>
                  ...
                  <div className="flex gap-10 flex-col lg:gap-24 lg:flex-row">
                    <div className="flex flex-col items-center">
                      <div className="flex flex-col lg:flex-row lg:justify-center lg:gap-10">
                        <div>
                          <div className="font-normal text-center text-[15px] lg:text-2xl mt-6 text-[#0F0F0F]">
                            {"Sunday Service"}
                          </div>
                        ...
                        <div>
                          <div className="font-normal text-[15px] lg:text-2xl mt-6 text-center text-[#0F0F0F]">
                            {"Bilingual Service"}
                          </div>
                      ...
                      <div className="font-normal w-[90vw] text-[15px] lg:text-2xl mt-10 text-start text-[#0F0F0F] flex flex-row justify-center lg:w-fit lg:justify-start">
                        <svg
                          className=" w-[24px] mr-2"
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 384 512"
        ...
        {SliderData.map((slide) => {
          return (
            <SwiperSlide key={slide.id}>
              <div className="flex flex-col lg:flex-row justify-evenly items-center h-[40rem] px-24 py-4 lg:py-24 bg-amber-400">
                <div className="text-gray-700 text-center px-4 lg:py-2 lg:m-2">
                  <div
                    className="mx-4 w-[224px] h-[202px] lg:w-[436px] lg:h-[372px]"
                    style={{ position: "relative" }}
