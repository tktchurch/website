...
function Footer() {
    return (
        <div>
        <footer className="p-4 bg-[#000000] text-white sm:p-6 dark:bg-gray-900">
            <div className="md:flex md:justify-center">
                <div className="mb-6 md:mb-0 mr-48">
                    <a href="https://flowbite.com/" className="flex items-center">
                        <img src="/assets/images/logo.png" className="mr-3 h-28" alt="FlowBite Logo"/>
                    </a>
                    <span className="text-sm sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/"
                        ...
                        <ul className=" dark:text-gray-400">
                            <li className="mb-4">
                                <a href="https://flowbite.com/" className="hover:underline">
                                    <p> Clock Tower Second Bazaar  <br /> {"\n"} Maruthi Veedhi,  Shivaji Nagar <br />{"\n"} Hyderabad, Telangana 500003 </p>
                                </a>
                            </li>
