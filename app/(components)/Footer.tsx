...
function Footer() {
    return (
        <div className=''>
            <footer className="p-4 bg-[#000000] text-white dark:bg-gray-900 lg:pt-6 pb-8">
                <div className="flex flex-col lg:flex-row lg:justify-evenly w-full">
                    <div className="mb-6 md:mb-0">
                        ...
                        <div className=' mt-12 lg:mt-0'>
                            ...
                            <ul className=" dark:text-gray-400">
                                <li className="mb-4">
                                    <a href="https://github.com/themesberg/flowbite" className="hover:underline flex flex-row gap-[10px]">
                                        <svg className=' w-[20px] fill-white' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                ...
                                <li className="mb-4">
                                    <a href="https://discord.gg/4eeurUVvTy" className="hover:underline flex flex-row gap-[10px]">
                                        <svg className=' w-[20px] fill-white' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                ...
                                <li className="mb-4">
                                    <a href="https://discord.gg/4eeurUVvTy" className="hover:underline flex flex-row gap-[10px]">
                                        <svg className=' w-[20px] fill-white' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
