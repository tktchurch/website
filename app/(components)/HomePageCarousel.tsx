...
function HomePageCarousel() {
  const slides = [
		...
		{
			url: "/assets/images/slider/3.jpeg",
		},
		{
			url: "/assets/images/slider/4.jpeg",
		},
		{
			url: "/assets/images/slider/5.jpeg",
		},
		{
  ...
  return (
    <div className="w-full h-[200px] lg:h-[600px] m-auto relative group">
      <div
